                ...
                <div className="p-6">
                  ...
                  <div className="mt-5 flex flex-wrap justify-center gap-3">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="mi-btn-white inline-flex items-center justify-center rounded-xl px-4 py-2.5 text-center font-semibold transition"
                    >
                      Dove siamo
                    </a>
                    ...
                    <Link
                      ...
                      className="font-heading inline-flex items-center justify-center rounded-xl bg-[#0B3B82] px-4 py-2.5 text-center font-semibold text-white transition hover:bg-[#082d63]"
                    >
                      Vedi volantino
                    </Link>
                    ...
                    <Link
                      ...
                      className="font-heading inline-flex items-center justify-center rounded-xl bg-[#ef382f] px-4 py-2.5 text-center font-bold text-white shadow-md transition hover:scale-[1.02]"
                    >
                      Vedi foto
                    </Link>
                  </div>
