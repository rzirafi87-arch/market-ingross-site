...
const items = newsItems.filter((item) => item.categoryKey === "aperture");

export default function NewsAperturePage() {
  return (
      ...
      <main>
        <section className="bg-slate-50 py-16 lg:py-24">
          <div className="mx-auto max-w-7xl px-4 lg:px-8">
            ...
            <h1 className="mt-3 text-4xl font-extrabold text-[#0B3B82] md:text-6xl">Le nostre aperture</h1>
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-600">
              Tutte le news sulle nuove aperture Market Ingross nei territori serviti.
            </p>
          </div>
        </section>
