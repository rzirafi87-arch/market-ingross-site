export default function NuovaAperturaVittoriaPage() {
  return (
    <main className="min-h-screen bg-[#f4d51f] px-4 py-12">
      <section className="mx-auto max-w-5xl rounded-[32px] bg-white p-6 shadow-xl md:p-10">
        ...
        <h1 className="mb-4 text-3xl font-extrabold text-[#063b78] md:text-5xl">
          Nuova apertura Market Ingross a Vittoria
        </h1>
        <p className="mb-8 max-w-3xl text-lg leading-relaxed text-slate-700">
          Grande apertura del nuovo punto vendita Market Ingross a Vittoria. Scopri il nostro supermercato.
        </p>
        <div className="overflow-hidden rounded-[24px] shadow-lg">
          <iframe
            className="aspect-video h-full w-full"
            src="https://www.youtube.com/embed/zxZLiBm4B9E"
        ...
        <div className="mt-8 rounded-2xl bg-[#fff7c7] p-5">
          <h2 className="mb-2 text-2xl font-extrabold text-[#063b78]">
            Punto vendita di Vittoria
          </h2>
          <p className="text-slate-700">📍 Vittoria</p>
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          ...
          <a
            href="/volantino/aperture/vittoria.pdf"
            target="_blank"
        ...
        <div className="mt-8 text-sm text-slate-500">Data apertura: 20/11/2025</div>
      </section>
    </main>
  );
}