...
const passaggi = [
  ...
  "Lava i pomodori e tagliali a pezzetti. Condiscili con olio extravergine d’oliva, sale e origano.",
  "Sistema i pomodori sul pane.",
  "Aggiungi il formaggio tagliato a fette o a pezzetti.",
  "Completa con i filetti di acciughe e un altro filo d’olio extravergine d’oliva.",
  "Se vuoi, aggiungi olive, capperi o basilico.",
  "Lascia riposare qualche minuto prima di servire, così il pane assorbe bene il condimento.",
];
          ...
          <div className="mx-auto max-w-4xl px-4 lg:px-8">
            ...
            <article className="mi-panel rounded-[32px] p-6 lg:p-10 lg:px-12">
              ...
              <p className="mt-6 text-base leading-8 text-slate-700 md:text-lg">
                Ci sono ricette che non hanno bisogno di essere complicate per diventare speciali. A volte basta una fetta di pane buono, un filo d’olio, qualche pomodoro maturo e il profumo dell’origano per portare in tavola tutto il sapore della Sicilia.
              </p>
              <p className="mt-4 text-base leading-8 text-slate-700 md:text-lg">
                Per il punto vendita di Castelvetrano, la ricetta scelta è il pane nero cunzato, una preparazione semplice, genuina e ricca di identità. Il protagonista è il pane nero di Castelvetrano, uno dei prodotti più riconoscibili del territorio, famoso per il suo colore scuro, la crosta profumata e la presenza dei semi di sesamo.
              </p>
              <p className="mt-4 text-base leading-8 text-slate-700 md:text-lg">
                Il pane nero non è un pane qualsiasi. Racconta la storia dei grani antichi, dei forni tradizionali e delle famiglie che per anni hanno portato in tavola pagnotte grandi, rustiche e profumate. La sua forza sta nella semplicità: farina, acqua, lievito naturale, sale e sesamo. Ma è proprio questa semplicità a renderlo unico.
              </p>
              ...
              <section className="mt-10 rounded-2xl border border-slate-200 bg-white p-5">
                ...
                <p className="mt-3 text-base leading-8 text-slate-700">
                  Per un risultato ancora più buono, scegli pomodori maturi e un olio extravergine profumato. Se vuoi prepararlo per una cena veloce, puoi tagliare il pane a pezzi più piccoli e servirlo come antipasto o aperitivo.
                </p>
              </section>
              <section className="mt-10 rounded-2xl bg-[#fff7c7] p-5">
                ...
                <p className="mt-3 text-base leading-8 text-slate-700">
                  Questa ricetta è dedicata al nostro punto vendita di Castelvetrano.
                </p>
                <p className="mt-3 text-base leading-8 text-slate-700">
                  Il pane nero cunzato è una ricetta semplice, rustica e piena di sapore: una fetta di Sicilia da preparare in pochi minuti con ingredienti genuini e facili da trovare ogni giorno da Market Ingross.
                </p>
              </section>
              <section className="mt-10 border-t border-slate-200 pt-8">
                ...
                <div className="mt-5 overflow-hidden rounded-2xl border border-slate-200 bg-white p-2">
                  <Image
                    src="/images/news/ricette/pane-nero-cunzato.png"
