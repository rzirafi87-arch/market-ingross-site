...
export const metadata: Metadata = {
  ...
  description:
    "Ricetta siciliana tradizionale: mostarda dâ€™uva (mustata) con mosto, mandorle, cannella. Dolce tipico della vendemmia a CanicattÃ¬.",
  keywords: [
    "mostarda d'uva",
    "mustata",
    "ricetta siciliana",
  ...
  openGraph: {
    title: "Mostarda dâ€™uva: il dolce profumo della vendemmia a CanicattÃ¬",
    description:
      "Dolce siciliano antico a base di mosto dâ€™uva, mandorle e cannella. Ricetta tipica della vendemmia a CanicattÃ¬.",
...
const ingredienti = [
  "1 litro di mosto dâ€™uva",
  "80/100 g di amido per dolci, farina o semola rimacinata",
  "80/100 g di mandorle tritate o noci",
  "cannella in polvere",
  "1 stecca di cannella, facoltativa",
  "scorza dâ€™arancia, facoltativa",
];

const passaggi = [
  "Versa il mosto dâ€™uva in una pentola e fallo scaldare lentamente.",
  "A parte, sciogli lâ€™amido o la farina con un poâ€™ di mosto freddo, mescolando bene per evitare grumi.",
  ...
  "Quando sarÃ  fredda, potrai gustarla al cucchiaio o tagliarla a fette, secondo la consistenza ottenuta.",
];
          ...
          <div className="mx-auto max-w-4xl px-4 lg:px-8">
            ...
            <article className="mi-panel rounded-[32px] p-6 lg:p-10 lg:px-12">
              ...
              <h1 className="font-heading mt-3 text-3xl font-extrabold text-[#0B3B82] md:text-5xl">
                Mostarda dâ€™uva: il dolce profumo della vendemmia a CanicattÃ¬
              </h1>
              <p className="mt-6 text-base leading-8 text-slate-700 md:text-lg">
                Ci sono sapori che arrivano in tavola solo in certi momenti dellâ€™anno. La mostarda dâ€™uva, in Sicilia chiamata anche mustata, Ã¨ uno di questi. Ãˆ un dolce semplice, antico, preparato con il mosto dâ€™uva, cioÃ¨ il succo dellâ€™uva appena pigiata, prima che diventi vino.
              </p>
              <p className="mt-4 text-base leading-8 text-slate-700 md:text-lg">
                Per il punto vendita di CanicattÃ¬, questa ricetta Ã¨ una scelta naturale. CanicattÃ¬ Ã¨ infatti fortemente legata alla coltivazione dellâ€™uva, in particolare allâ€™Uva da Tavola di CanicattÃ¬ IGP, un prodotto riconosciuto e rappresentativo del territorio.
              </p>
              <p className="mt-4 text-base leading-8 text-slate-700 md:text-lg">
                La mostarda dâ€™uva racconta proprio questo legame: il rapporto tra la terra, la vendemmia, la famiglia e la cucina di casa. Non Ã¨ una torta e non Ã¨ una crema normale. Ãˆ piÃ¹ simile a un budino rustico, compatto e profumato, preparato con mosto, farina o amido, cannella e frutta secca.
              </p>
              ...
              <section className="mt-10 rounded-2xl border border-slate-200 bg-white p-5">
                ...
                <p className="mt-3 text-base leading-8 text-slate-700">
                  Per renderla ancora piÃ¹ profumata, puoi aggiungere un poâ€™ di cannella sopra prima di servirla. Se vuoi una versione piÃ¹ ricca, usa mandorle tostate tritate grossolanamente.
                </p>
              </section>
              <section className="mt-10 rounded-2xl bg-[#fff7c7] p-5">
                ...
                <p className="mt-3 text-base leading-8 text-slate-700">
                  Questa ricetta Ã¨ dedicata al nostro punto vendita di CanicattÃ¬, cittÃ  legata alla tradizione dellâ€™uva e ai sapori della vendemmia.
                </p>
                <p className="mt-3 text-base leading-8 text-slate-700">
                  La Mostarda dâ€™uva Ã¨ un dolce semplice, antico e profumato: una ricetta che porta in tavola il gusto autentico della Sicilia.
                </p>
              </section>
              <section className="mt-10 border-t border-slate-200 pt-8">
                ...
                <div className="mt-5 overflow-hidden rounded-2xl border border-slate-200 bg-white p-2">
                  <Image
                    src="/images/news/ricette/guida illustrativa/mostarda-uva.png"
                    alt="Guida illustrativa Mostarda dâ€™uva"
                    width={1600}
                    height={2200}
